...
export default observer(function VisualCheckBoxControls({
  metronomeManager,
  ...
  return (
    <div className="checkbox-controls-container container">
      <ToggleCheckbox
        ...
        onChange={() =>
          metronomeManager.visualEffectsManager.togglePendulumVisibility()
        }
      ...
      <ToggleCheckbox
        ...
        onChange={() =>
          metronomeManager.visualEffectsManager.toggleFlashingBarVisibility()
        }
      ...
      <ToggleCheckbox
        ...
        onChange={() =>
          metronomeManager.visualEffectsManager.toggleBeatBarsVisibility()
        }
